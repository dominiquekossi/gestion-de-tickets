...
const tickets: Ticket[] = [
  {
    ...
    title: 'Impossible de réinitialiser mon mot de passe',
    status: 'open',
    createdAt: '2026-09-02T09:14:00.000Z',
  },
  {
    id: 'b27d94f1-0e6a-4d33-8c15-52a9f7c4e881',
    title: "La facture de janvier n'est pas téléchargeable",
    status: 'closed',
    createdAt: '2026-09-05T14:32:00.000Z',
  },
  {
    id: 'd3a8e510-9c47-4f2b-b6de-1a0c85f39b74',
    title: 'Ajouter un export CSV de la liste des clients',
    status: 'open',
